...
readiris = read.csv(file="./data/irisF.csv", header = T,sep = ",")# header =true means first row conatins column name
readiris
...
str(read3) ; class(read3)#semicolon can combine the commands
head(read3)
?read.delim
